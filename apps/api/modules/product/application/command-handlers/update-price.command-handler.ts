import type { ICommandHandler } from '@ecomerece/domain';
import type { UpdatePriceCommand } from '../commands/update-price.command';
import type { ProductInternelService } from '../product.internel.service';

export class UpdatePriceHandler implements ICommandHandler<{ ok: boolean }, UpdatePriceCommand> {
