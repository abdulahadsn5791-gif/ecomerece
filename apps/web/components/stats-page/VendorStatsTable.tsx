...
interface VendorStatsTableProps {
  vendors: VendorStatsRow[];
...
export const VendorStatsTable = ({
  vendors,
  selectedId,
  onSelect,
  accent = '#7C3AED',
  delay = 0.2,
}: VendorStatsTableProps) => {
  const { darkMode } = useThemeStore();

  const rows = [...vendors].sort((a, b) => b.metrics.revenue - a.metrics.revenue);
                  ...
                  <td className="py-3 pr-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <span
                          className={`block font-medium truncate max-w-[200px] ${
