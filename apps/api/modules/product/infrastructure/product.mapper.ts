...
import type { Metrics, ProductResponseReadModel } from '@ecomerece/shared';
...
export function publicProductStats(stats: Metrics | undefined): ProductResponseReadModel['stats'] {
  if (!stats) return undefined;
  const out: ProductResponseReadModel['stats'] = {};
...
export const ProductMapper = {
  ...
  aggregateToResponseReadModel(product: ProductAggregate): ProductResponseReadModel {
    return {
      ...
      minDiscountedPrice: product.minDiscountedPrice.value,
      maxDiscountedPrice: product.maxDiscountedPrice.value,
      stats: publicProductStats(product.stats),
      createdAt: product.createdAt.value,
    };
  },
