        ...
        <div className={darkMode ? 'dark' : ''}>
            <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300 relative">
                ...
                <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-6 py-5 sm:px-8">
                    <a href="#" className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
                ...
                <div className="flex min-h-screen">
                    ...
                    <div className="flex-1 flex items-center justify-center px-6 pt-28 pb-10 sm:px-10">
                        <div className="w-full max-w-md">
                            ...
                            {/* Toggle tabs */}
                            <div className="flex gap-1 bg-gray-100 dark:bg-gray-800 rounded-full p-1 mb-8">
                                <button
                            ...
                            {/* Google Sign-In / Sign-Up Button (official style) */}
                            <button
                                className="w-full flex items-center justify-center gap-3 h-12 px-4 rounded-[4px] bg-white border border-[#dadce0] text-[#3c4043] font-medium text-sm tracking-wide transition-colors hover:bg-[#f8f9fa] hover:shadow-sm active:bg-[#f1f3f4]"
                            >
                                {/* Google G logo */}
                            ...
                            <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-5">
                                ...
                                <a href="#" className="underline text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">
                                    Terms of Service
                                </a>{' '}
                                and{' '}
                                <a href="#" className="underline text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">
