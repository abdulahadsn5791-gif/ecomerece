...
import { IProductVariantRepository } from "../domain/ports/i-product-variant-repository";
...
import { ProductVariantModel, ProductVariantPersistence } from "./product-variant.model";

export class ProductVariantRepository extends MongoRepository<ProductVariantPersistence> implements IProductVariantRepository {
    constructor() {
    ...
    async EnsureOwnerShipGetByIdOrThrow(productId: Id, variantId: Id): Promise<ProductVariantAggregate> {
