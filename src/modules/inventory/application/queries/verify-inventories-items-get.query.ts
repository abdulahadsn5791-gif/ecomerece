...
export class VerifyInventoriesItemsGetQuery
    implements IQuery<{ invalidIds: Id[], validIds: Id[], availableStockIds: Id[], buyableIds: Id[], inventoriesReadModel: InventoryReadModel[] }> {
    readonly __result?: { invalidIds: Id[], validIds: Id[], availableStockIds: Id[], buyableIds: Id[], inventoriesReadModel: InventoryReadModel[] };
